...
const Footer = () => {
  const navItems = ["Product", "Services", "Resources", "About Us", "Impact", "Contact Us"];
  
  return (
    <div className="flex flex-col bg-[#123059]">
      {/* Navigation Bar */}
      <nav className="bg-[#123059] p-4">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row md:justify-between items-center">
          ...
          <div className="flex flex-col lg:flex-row gap-5 py-6 lg:items-center ">
            {navItems.map((item) => (
              <a key={item} href="#" className="text-white hover:text-yellow-400">
                {item}
              </a>
            ))}
          </div>
